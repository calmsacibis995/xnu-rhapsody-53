...
//	and	dword ptr %gs:sr_masks, 0fffff3ffh; set rounding control to nearest
	orl	$0x0300,%gs:sr_masks 	// set precision control to prec64
...
atn_loop_back_1:
	...
	andl	$0x0ff000000,dword_frac2(%ebp)	// frac2 = 64 bits x
	...
	andl	$0x0ff000000,dword_frac2(%ebp)
	jmp	atn_merge_0
	ALIGN
atn_shift_left:
...
atn_merge_0:
	...
	andl	$0x0e0000000,dword_frac1(%ebp)
	movl	$15,dword_exp_tmp
...
// the following call used to be to divx instead of accel_divx:
	...
	andl	$0x0ffe00000,dword_frac1(%ebp)
	call	move_result_frac2
	call	right_shift_frac2_8
	andl	$0x0ffe00000,dword_frac2(%ebp)
	andl	$0x0e0000000,result_dword_frac(%ebp)// mask result frac
	...
	andl	$0x0e0000000,dword_frac2(%ebp)
	cmpb	$0,msb_dop
	movb	$1,%al
	mov	$7,%ecx
	jne	atn_merge_1
...
// the following call used to be to divx instead of accel_divx:
	call	accel_divx
	andl	$0x0e0000000,result_dword_frac(%ebp)// theta is here
	pop	%eax
	shrb	$1,%al
	mov	$7,%ecx
	jnb	atn_merge_2
...
move_unpacked_0_to_edi:	//proc
	...
	movl	$0,frac32(%ebp,%edi)
	movl	$0x10000*SPECIAL+POSITIVE,sign(%ebp,%edi)
	movl	$0,expon(%ebp,%edi)
	ret
...
move_unpacked_hapi_to_edi:	//proc
	...
	movl	$0,(%ebp,%edi)
	movl	$0x2168c235,frac64(%ebp,%edi)
	movl	$0x0c90fdaa2,frac32(%ebp,%edi)
	movl	$0x10000*VALID+POSITIVE,sign(%ebp,%edi)
	movl	$0x3fff,expon(%ebp,%edi)
	ret
...
at_ops_eql:
	...
	decl	dword_result_expon				// make pi/4
	or	%ebx,%ebx
	jz	at_sign_adjust
	jmp	hapi_to_op1
	ALIGN
...
two_arg_special_case_:
	andb	$~a_mask,%gs:sr_flags		// clear a-bit initially
...
sign_y_pi:
	mov	$offset_result,%edi
	call	move_unpacked_hapi_to_edi
	incl	dword_result_expon			// make pi
...
zerror_flip_sign_y_inf:
	...
	jz	two_arg_unmasked_exit
flip_sign_y_inf:
	movl	$0x080000000,dword_frac1+frac32(%ebp)
	movl	$0x10000*INFINITY+POSITIVE,sign1(%ebp)
	movl	$0x7fff,dword_expon1
flip_sign_y_op1:
	mov	$offset_operand1,%edi
flip_sign_y_to_edi:
	movb	sign2(%ebp),%dl
...
inv_or_op2_signed_by_op1_vs_1:
	...
	jg	op2
	jl	flip_sign_op2
	cmpl	$0x80000000,dword_frac1+frac32(%ebp)
	ja	op2
	cmp	$0,dword_frac1+frac64(%ebp)
	jne	op2
	jmp	op_unsupp
...
move_unpacked_1_to_esi:	//proc
	...
	movl	$0,(%ebp,%esi)
	movl	$0,frac64(%ebp,%esi)
	movl	$0x080000000,frac32(%ebp,%esi)
//	mov	positive+0x10000*valid,sign(%ebp,%esi)
	movl	$0x10000*VALID+POSITIVE,sign(%ebp,%esi)
	movl	$0x3fff,expon(%ebp,%esi)
	ret
...
//
	...
	add	$10,%ecx
	call	right_shift_result_cl
	andl	$0x0ffe00000,result_dword_frac(%ebp)
	call	move_cop_frac1
	call	right_shift_frac1_8
	call	move_result_frac2
	call	subx
...
//	mov	positive+valid\*0x10000,result_sign(%ebp)
	movl	$0x10000*VALID+POSITIVE,result_sign(%ebp)
...
more_than_half_:
	...
	push	%gs:sr_masks	// save precision control
	orl	$0x0300,%gs:sr_masks 	// set precision control to prec64
	andl	$0x0fffff3ff,%gs:sr_masks	// set rc = to_nearest
	cmpl	$0x3ffe,dword_expon1
	je	maybe_half
	cmpb	positive,sign1(%ebp)
...
log_small_lg:
	...
	call	test_5w
	jz	log_power_of_two
	movl	$0x3ffe,dword_result_expon
	mov	$offset_result,%edi
...
//log_y_not_zero:
	andl	$0x0ff000000,dword_cop(%ebp)
...
log_large_lg:
	...
	movl	$0x3fff,dword_result_expon
log_merge_lg:
	mov	$offset_result+frac80,%edi	// dont normalize a zero
...
log_loop_back_1:
	...
	call	right_shift_frac1_cl
	orl	$0x00800000,dword_frac1+frac32(%ebp)
	call	addx
	cmpb	$0,msb_result
	je	log_merge_2
	andl	$0x0ffe00000,result_dword_frac(%ebp)
...
log_label_6:
	call	right_shift_frac2_cl
	andl	$0x0f0000000,dword_frac2(%ebp)
	call	subx
	andl	$0x0e0000000,result_dword_frac(%ebp)// mask result frac
	call	move_dop_frac1
	call	move_result_frac2
...
log_end_loop:
	...
	mov	%eax,dword_result_expon
	andl	$0x0ffe00000,result_dword_frac(%ebp)
	mov	$offset_result,%edi	// dont normalize a zero
...
addition_normalize:	//proc
	...
	ALIGN
right_shift_1:
	incl	expon(%ebp,%edi)	//increment exponent
...
sticky_right_shift:	//proc
	...
	and	%edx,%edx				//edx <> 0 if 1s lost
	jz	sticky_right_shift_done		//done if no 1s lost
...
//		stack top is unchanged; i.e., if it was empty as stack top, its
//		still empty as st(1).
...
//		that return to e80387 executive after popping callers return
...
//		flag and pops callers return address so that return is to
...
//		executive by popping callers return address and jumping to
//		do_exchange.
//		b.  if tag is inv, checks whether the nan in operand1 is
//		signaling.  if not, sets zf, pops callers return address,
...
//		pops callers return address so that return is to e80387
...
two_result_op1_chk:	//proc
	...
	andb	$~c_mask,%gs:sr_flags		// clear 87 c-flag
	testb	invalid_mask,%gs:sr_masks
...
// 87 c-flag has been cleared by this point
	...
	pop	%eax			// get rid of callers return address
	ret
	ALIGN
do_reduction:
	movl	$0x2168c235,dword_frac2+frac64(%ebp)
	movl	$0x0c90fdaa2,dword_frac2+frac32(%ebp)
	movl	$0x10000*VALID+POSITIVE,dword_frac2+sign(%ebp)
	movl	$0x3ffe,dword_expon2
	sub	%eax,dword_expon1
	inc	%eax
	call	remrx
	mov	dword_frac1+frac64(%ebp),%eax
	...
	mov	%eax,dword_expon1
	movl	special,dword_frac1+tag(%ebp)
	jmp	reduce_pi
	ALIGN
mod_not_0:
	mov	$offset_operand1,%edi
...
tan_pseudo_divide:	//proc
	...
	cmp	$16,%eax
	jg	tan_rat_appx
	decl	dword_expon1		// decrement expon1
	call	right_shift_frac1_8
tan_loop_back_1:
	mov	$10,%eax
	mull	dword_expon1
...
tan_rat_appx:
	...
	add	$8,%ecx
	call	right_shift_result_cl
	andl	$0x0ff000000,result_dword_frac(%ebp)	// 64 bits only
	call	move_result_frac2
	...
	decl	dword_expon1			// is a 67 bits temp
//
//pseudo_multiply
//
tan_loop_back_2:
...
tan_merge_2:
	...
	andl	$0x0ffe00000,dword_dop(%ebp)
	decl	dword_expon1
	jmp	tan_loop_back_2
	ALIGN
tan_almost_end:
...
//
	...
	call	left_shift_frac2_8
	movl	$0x3fff,dword_expon2
	movl	$0x10000*VALID+POSITIVE,sign2(%ebp)
//
//normalize x
//
	mov	$offset_operand2,%edi
...
reduce_op1:
	...
	jne	zero_modulus
	movl	$0,dword_frac1(%ebp)
	movl	$0,dword_frac1+frac64(%ebp)
	movl	$0x080000000,dword_frac1+frac32(%ebp)
	movl	$0x10000*INFINITY+POSITIVE,dword_frac1+sign(%ebp)
	movl	$0x7fff,dword_frac1+expon(%ebp)
...
tan_tiny_argument:
	...
	jnz	need_grad_uflow
	addl	wrap_around_constant,dword_expon1
	jmp	zero_modulus
	ALIGN
need_grad_uflow:
	mov	$offset_operand1,%edi
...
sin_specific:	//proc
	...
	orl	$0x0f00,%gs:sr_masks 	// set rc to chop!
	movb	$add_op,operation_type(%ebp)
	call	subadd
	call	post_op_round
	lea	result_dword_frac(%ebp),%esi
...
check_sin_lim:
	...
	cmpl	$0x08d100000,dword_frac1+frac32(%ebp)
	ja	sin_calc
	jb	sin_0_modulus
	cmp	$0,dword_frac1+frac64(%ebp)
	je	sin_0_modulus
...
//cos_cofunc?:
	...
	movl	$0,result_dword_frac+frac32(%ebp)
	movl	$0x10000*SPECIAL+POSITIVE,result_sign(%ebp)
	movl	$0,dword_result_expon
	jmp	attach_cos_sign
	ALIGN
cos_tiny_:
	cmpb	true,cofunc_flag
...
get_out_shfts:
	...
	or	4(%ebp,%edi),%edx // and ord to edx
	or	8(%ebp,%edi),%edx
...
bits_shft_rt:
	...
	mov	(%ebp,%edi),%eax
	xor	%ebx,%ebx
	shrdl	%cl,%eax,%ebx  // cl is interpreted mod 32
	or	%ebx,%edx
bit_shft_loop:
	mov	4(%ebp,%edi),%eax
	shrdl	%cl,%eax,(%ebp,%edi)
	add	$4,%edi
	decb	%ch
	jnz	bit_shft_loop
	pop	%eax
...
//	push	%ss
//	pop	%es
/* Note direction is not appropriate for FAST_MOVSB */
	push	%eax
1:
	movb	0(%esi),%al
	movb	%al,0(%edi)
...
one_left_normalize:	//proc
	...
	pop	%edi				// reload frac offset
	decl	expon(%ebp,%edi)	//decrement exponent
	testb	$0x80,frac80+9(%ebp,%edi)	//normalized?
one_left_norm_done:
	ret
