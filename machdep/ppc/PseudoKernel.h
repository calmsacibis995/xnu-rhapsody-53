...
/*
	...
	File Ownership:
		...
		Other Contact:	Jeff Robbin

		Technology:	TruBlue Virtual Machine
...
//	EmulatorDescriptor
//
//	Emulator image descriptor record appended to the 68K emulator
//	image by the BootPowerPC project. 
//
...
enum {
	...
	kOutsideBlue		=	5,			// Currently executing outside of the blue box
