...
extern zone_t	u_task_zone;	/* UNIX */
	...
	vm_size_t	map_size)
{
	...
	task_deallocate(new_task); // extra ref for convert_task_to_port()
	...
	task_t		*child_task)		/* OUT */
{
	...
	new_task->pcb_common = 0;
	pcb_common_init(new_task);
