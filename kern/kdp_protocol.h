 ...
 *
 * HISTORY
 * 10-Nov-1997  Umesh Vaishampayan  (umeshv@apple.com)
 *	Changed the magic numbers for udp ports.
 *
 * 10 Nov 97	Herb Ruth [ruth1@apple.com]
 *	Removed trailing comma from kdp_req_t enumeration.
 *
