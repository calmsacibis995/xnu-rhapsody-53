 ...
 * HISTORY
 * 18 May 1992 ? at NeXT
 *	Expanded to handle little endian machines.
 *
...
#if 0
	/*
	 * It is incorrect to assume that vp->v_vm_info->vnode_size
	 * would be initialized at this point.
	 */
	if (vp->v_vm_info) {
	if (end_of_archs > vp->v_vm_info->vnode_size)
