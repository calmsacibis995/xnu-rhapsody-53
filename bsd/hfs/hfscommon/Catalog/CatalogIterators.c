...
/*
	...
	Change History (most recent first):
	   <Rhap>	 4/23/98	djb		Re-enable InvalidateCatalogCache (was commented out).
	   <Rhap>	  4/6/98	djb		Add locking for cache globals (list) and iterators.
	   <Rhap>	  4/2/98	djb		Define gCatalogCacheGlobals here instead of FSVars.
