...
*/
#if 0
extern OSErr ConvertUnicodeToHFSName( ConstHFSUniStr255Param unicodeName, TextEncoding encoding, HFSCatalogNodeID cnid, Str31 hfsName );
#endif
...
extern OSErr ConvertHFSNameToUnicode( ConstStr31Param hfsName, TextEncoding encoding, HFSUniStr255 *unicodeName );


extern OSErr ConvertUTF8ToUnicode ( ByteCount srcLen,
								    const unsigned char* srcStr,
									ByteCount maxDstLen,
					 				ByteCount *actualDstLen,
									UniCharArrayPtr dstStr );

extern OSErr ConvertUnicodeToUTF8 ( ByteCount srcLen,
...
extern OSErr ConvertMacRomanToUTF8 (Str31 srcStr,
									ByteCount maxDstLen,
					 				ByteCount *actualDstLen,
									unsigned char* dstStr);
...
extern HFSCatalogNodeID GetEmbeddedFileID( ConstStr31Param filename, UInt32 *prefixLength );
