 ...
 *
 * ATADiskInt.h - private categories and typedefs for ATADisk class.
 *
 * HISTORY 
...
#ifndef	_BSD_DEV_ATADISKINTERNAL_H
#define _BSD_DEV_ATADISKINTERNAL_H
...
/*
 * General utility methods in ATADiskInternal.m.
 */
@interface ATADisk(Internal)
...
@end	/* ATADisk(Internal) */

#endif	/* _BSD_DEV_ATADISKINTERNAL_H */
