 ...
 *
 * ATADisk.h - Exported Interface for IDE/ATA Disk device class. 
 *
 * HISTORY 
 *
...
#ifndef	_BSD_DEV_ATADISK_H
#define _BSD_DEV_ATADISK_H 1
...
@interface ATADisk:IODisk<IODiskReadingAndWriting, IOPhysicalDiskMethods>
{
@private
    /*
...
#define MAX_NUM_ATABUF		128
    ...
    unsigned 		_ideReadCommandPIO;
    unsigned 		_ideWriteCommandPIO;

    u_int		_ideControllerType;
