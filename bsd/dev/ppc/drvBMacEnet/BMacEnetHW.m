...
{
  WriteSwap16( ioBaseEnet, reg_offset, data );
  eieio();
}
...
{
  return ReadSwap16( ioBaseEnet, reg_offset ); 
}
...
unsigned short read_srom(IOPPCAddress base, unsigned int addr, unsigned int addr_len)
{
