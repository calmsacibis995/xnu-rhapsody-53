...
/*
 	...
 	BuildInfo:	Built by:			Naga Pappireddi
 				...
 				From:				MacTypes.i
 					...
 					Dated:			7/17/98
 					Last change by:	ngk
 					Last comment:	[2237881]  Add ConstStringPtr
...
//naga typedef wide 							SInt64;
//naga typedef UnsignedWide 					UInt64;
//naga#endif	/* TYPE_LONGLONG */
...
//nagatypedef UnsignedWide 					AbsoluteTime;
typedef unsigned long long  					AbsoluteTime;
...
/*********************************************************************************
	...
	Name			MacsBug			Macintosh Debugger					
	----------		-----------		-----------------------------	
	Debugger		yes				InterfaceLib maps to DebugStr	
	DebugStr		yes				yes								
	debugstr		yes				InterfaceLib maps to DebugStr	
	SysBreak		no				InterfaceLib maps to SysError	
	SysBreakStr		no				InterfaceLib maps to SysError	
	SysBreakFunc	no				InterfaceLib maps to SysError	
	SysDebug		?				?								
	SysDebugStr		?				?								
