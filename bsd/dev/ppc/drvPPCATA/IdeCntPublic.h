...
#ifndef	_BSD_DEV_I386_IDECNTPUBLIC_H_
#define _BSD_DEV_I386_IDECNTPUBLIC_H_
...
- (ideIdentifyInfo_t *) getIdeIdentifyInfo:(u_int)unit;
- (u_int) getMultiSectorValue:(u_int)unit;
- (u_int) numberOfDrives;
- (ideDriveInfo_t *) getIdeDriveInfo:(u_int)unit;
