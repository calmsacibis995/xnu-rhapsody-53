...
//
// PPCMouse.h - Interface to PPC mouse object
// 
//
// HISTORY
...
@interface PPCMouse : PCPointer
{
@private
    PPCKeyboard *kbdDevice;	// The keyboard device we are based on
    int	resolution;		// dots per inch
}
