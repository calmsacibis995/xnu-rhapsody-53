...
#define DDP_MAX_DATA 586	/* should probably be somewhere else... */
...
#define RT_LOOKUP(x) rt_blookup(x.NetStop)
...
#define ZT_ADD_ZONE(name, length)  zt_add_zone(name, length)
/*
